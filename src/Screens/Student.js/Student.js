...
import { stuDetails,postShow,logout } from '../../Store/Actions/Actions'
      ...
      <View style={styles.main}>
        ...
        <View style={styles.view3}>
          {/* <TouchableOpacity style={styles.Butnblood} onPress={() => AvailableBlood(this.props)}> */}
            <Text style={styles.BtnTextblod}>Student Dashboard</Text>
          {/* </TouchableOpacity> */}
        </View>
        {/* <View style={styles.view3}>
        ...
        <View style={styles.view3}>
          <TouchableOpacity style={styles.Butnblood} onPress={() => postShow(this.props)}>
            <Text style={styles.BtnTextblood}>Job Updates</Text>
          </TouchableOpacity>
        </View>
...
const mapDispatchToProps = (dispatch) => ({
    ...
    postShow: (props) => dispatch(postShow(props)),
