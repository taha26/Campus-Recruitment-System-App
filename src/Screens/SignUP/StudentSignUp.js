...
import { studentSignUp } from '../../Store/Actions/Actions'
  ...
  render() {
    return (
      <Container>
        ...
        <Button onPress={() => studentSignUp(this.state, this.props)} info style={{marginTop:100,width:180,alignSelf:'center',paddingLeft:40,borderRadius:20}} ><Text style={{fontSize:19,fontWeight:'bold'}}>Sign Up</Text></Button>
        </Content>
      </Container>
    );
  }
...
const mapDispatchToProps = (dispatch) => ({
    studentSignUp: (state,props) => dispatch(studentSignUp(state,props)),
